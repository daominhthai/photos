...
<header class="mdc-top-app-bar mdc-top-app-bar--fixed" id="app-bar">
    <div class="mdc-top-app-bar__row">
        ...
        <section class="mdc-top-app-bar__section mdc-top-app-bar__section--align-end" role="toolbar">   
            <a href="#" class="material-icons mdc-top-app-bar__action-item" aria-label="ReDelete" >history</a>   
            <a href="#" class="material-icons mdc-top-app-bar__action-item" aria-label="Delete_forever" >delete_forever</a>
        </section>
    </div>
</header>
